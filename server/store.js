...
//
//    Ограничение: кастомные стикеры (сами файлы, не метаданные) по-прежнему
//    хранятся только на локальном диске в STICKERS_DIR — в удалённом режиме
//    на Render Free они не переживут передеплой. HTML мини-приложений от
//    этого ограничения больше не страдает: он дублируется прямо в метаданных
//    (miniApps), которые уходят в удалённый стор вместе со всем остальным —
//    см. app.get('/apps/:id.html', ...) в index.js. Аккаунты, пароли, чаты,
//    сообщения, контакты и мини-приложения — переживают передеплой.
// ------------------------------------------------------------------
